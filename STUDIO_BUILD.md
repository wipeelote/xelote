# Debris Clear: Roblox Studio build sheet

> **For Claude:** this document is the complete source of a 4-player, server-authoritative Roblox minigame (Machine Party-style *Debris Clear*). Recreate it in the open Roblox Studio place **exactly** as listed below. Do not rewrite, reformat, or "improve" any script while copying it.
...
1. Create these **Folders** (the last path segment is the folder's name; the rest already exist):
   ...
   - `ServerScriptService.DebrisClear.Map`
...
```text
ReplicatedStorage.DebrisClear (Folder)
   ├─ Config (ModuleScript)
   ├─ Ballistics (ModuleScript)
   ├─ DecahedronMesh (ModuleScript)
   ├─ HexGeometry (ModuleScript)
   ├─ Remotes (ModuleScript)
ServerScriptService.DebrisClear (Folder)
   ├─ Main (Script)
   ├─ Arena (ModuleScript)
   ├─ DebrisService (ModuleScript)
   ├─ LoadService (ModuleScript)
   ├─ RateLimiter (ModuleScript)
   ├─ ThrowService (ModuleScript)
ServerScriptService.DebrisClear.Map (Folder)
   ├─ Hub (ModuleScript)
   ├─ Lighting (ModuleScript)
   ├─ MapKit (ModuleScript)
   ├─ Pit (ModuleScript)
   ├─ PlatformDressing (ModuleScript)
...
While you hold debris, a dotted arc previews where it will land: green means in range, orange means out of range.

## Scripts

### 1. `ReplicatedStorage.DebrisClear.Config`: **ModuleScript**

_Repo file: `src/shared/Config.luau`_
...
### 2. `ReplicatedStorage.DebrisClear.Ballistics`: **ModuleScript**

_Repo file: `src/shared/Ballistics.luau`_
...
### 3. `ReplicatedStorage.DebrisClear.DecahedronMesh`: **ModuleScript**

_Repo file: `src/shared/DecahedronMesh.luau`_
...
### 4. `ReplicatedStorage.DebrisClear.HexGeometry`: **ModuleScript**

_Repo file: `src/shared/HexGeometry.luau`_
...
### 5. `ReplicatedStorage.DebrisClear.Remotes`: **ModuleScript**

_Repo file: `src/shared/Remotes.luau`_
...
### 6. `ServerScriptService.DebrisClear.Main`: **Script**

_Repo file: `src/server/Main.server.luau`_
...
### 7. `ServerScriptService.DebrisClear.Arena`: **ModuleScript**

_Repo file: `src/server/Arena.luau`_
...
### 8. `ServerScriptService.DebrisClear.DebrisService`: **ModuleScript**

_Repo file: `src/server/DebrisService.luau`_
...
### 9. `ServerScriptService.DebrisClear.LoadService`: **ModuleScript**

_Repo file: `src/server/LoadService.luau`_
...
### 10. `ServerScriptService.DebrisClear.RateLimiter`: **ModuleScript**

_Repo file: `src/server/RateLimiter.luau`_
...
### 11. `ServerScriptService.DebrisClear.ThrowService`: **ModuleScript**

_Repo file: `src/server/ThrowService.luau`_
...
### 12. `ServerScriptService.DebrisClear.Map.Hub`: **ModuleScript**

_Repo file: `src/server/Map/Hub.luau`_
...
### 13. `ServerScriptService.DebrisClear.Map.Lighting`: **ModuleScript**

_Repo file: `src/server/Map/Lighting.luau`_
...
### 14. `ServerScriptService.DebrisClear.Map.MapKit`: **ModuleScript**

_Repo file: `src/server/Map/MapKit.luau`_
...
### 15. `ServerScriptService.DebrisClear.Map.Pit`: **ModuleScript**

_Repo file: `src/server/Map/Pit.luau`_
...
### 16. `ServerScriptService.DebrisClear.Map.PlatformDressing`: **ModuleScript**

_Repo file: `src/server/Map/PlatformDressing.luau`_
...
### 17. `ServerScriptService.DebrisClear.Map.Showcase`: **ModuleScript**

_Repo file: `src/server/Map/Showcase.luau`_
...
### 18. `ServerScriptService.DebrisClear.Map.Towers`: **ModuleScript**

_Repo file: `src/server/Map/Towers.luau`_
...
### 19. `StarterPlayer.StarterPlayerScripts.DebrisClear.Main`: **LocalScript**

_Repo file: `src/client/Main.client.luau`_
...
### 20. `StarterPlayer.StarterPlayerScripts.DebrisClear.DebrisVisuals`: **ModuleScript**

_Repo file: `src/client/DebrisVisuals.luau`_
